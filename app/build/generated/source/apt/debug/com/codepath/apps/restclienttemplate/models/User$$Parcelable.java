    ...
    implements Parcelable, ParcelWrapper<com.codepath.apps.restclienttemplate.models.User>
{
    ...
    public static void write(com.codepath.apps.restclienttemplate.models.User user$$1, android.os.Parcel parcel$$1, int flags$$0, IdentityCollection identityMap$$0) {
        ...
        if (identity$$0 != -1) {
            ...
            parcel$$1 .writeLong(InjectionUtil.getField(long.class, com.codepath.apps.restclienttemplate.models.User.class, user$$1, "uid"));
            parcel$$1 .writeString(InjectionUtil.getField(java.lang.String.class, com.codepath.apps.restclienttemplate.models.User.class, user$$1, "name"));
            parcel$$1 .writeString(InjectionUtil.getField(java.lang.String.class, com.codepath.apps.restclienttemplate.models.User.class, user$$1, "screenName"));
            parcel$$1 .writeString(InjectionUtil.getField(java.lang.String.class, com.codepath.apps.restclienttemplate.models.User.class, user$$1, "profileImageUrl"));
        }
    }
    ...
    public static com.codepath.apps.restclienttemplate.models.User read(android.os.Parcel parcel$$3, IdentityCollection identityMap$$1) {
        ...
        if (identityMap$$1 .containsKey(identity$$1)) {
            ...
            InjectionUtil.setField(com.codepath.apps.restclienttemplate.models.User.class, user$$4, "uid", parcel$$3 .readLong());
            InjectionUtil.setField(com.codepath.apps.restclienttemplate.models.User.class, user$$4, "name", parcel$$3 .readString());
            InjectionUtil.setField(com.codepath.apps.restclienttemplate.models.User.class, user$$4, "screenName", parcel$$3 .readString());
            InjectionUtil.setField(com.codepath.apps.restclienttemplate.models.User.class, user$$4, "profileImageUrl", parcel$$3 .readString());
